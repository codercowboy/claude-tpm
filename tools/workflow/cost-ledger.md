# `cost-ledger.js` — per-subagent cost ledger (v2, epic-aware)

Reference doc for `tools/cost-ledger.js`. Every claim below was confirmed by running the canonical tool
