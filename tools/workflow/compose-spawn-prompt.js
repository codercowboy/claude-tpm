#!/usr/bin/env node
/**
 * compose-spawn-prompt.js - mechanically emit the standard subagent
 ...
 * through `lint-subagent-prompt.js --sentinels-only` and it will FLAG the
...
function compose(opts) {
  ...
  // Marker the spawn-gate hook (tools/workflow/hooks/gate-spawn.js) keys off: a positive, unambiguous
  ...
  // token in the worker's Read; in claude-admin TPM_HOME="." so it reads the repo root). Bare paths
