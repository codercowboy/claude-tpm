#!/usr/bin/env node
/**
 * tpm-consumer-check-json.js — read a headless-`claude -p` answer on STDIN, extract the JSON object the probe asked
 ...
 * check its fields.
 *
 * Usage (piped):  <claude -p …> | node tpm-consumer-check-json.js <checks…>
