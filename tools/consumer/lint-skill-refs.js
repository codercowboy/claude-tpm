#!/usr/bin/env node
/**
 * lint-skill-refs.js — keep the tpm-* skills RELOCATABLE. A consumer runs the skills from a project
 ...
 *
 * Usage:  node tools/consumer/lint-skill-refs.js [<dir-or-file> …]   (default: .claude/skills)
