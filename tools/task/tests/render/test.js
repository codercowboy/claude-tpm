#!/usr/bin/env node
/**
 * tests/render/test.js — unit suite for tpm-task-render.js (age ladder G2, sort orders, selector grammar G5).
 *
 * WHAT IT GUARDS
...
process.stdout.write(`\nPASS — ${count()}/${count()} tpm-task-render.js assertions green\n`);
