#!/usr/bin/env node
/**
 * tests/task/bug-repros.test.js — failing repros for confirmed defects (NOT in run-all.js).
 *
 * PURPOSE
 ...
 *
 * HOW TO RUN
 *   node tests/task/bug-repros.test.js     # exit 0 only when ALL listed bugs are fixed
 */
