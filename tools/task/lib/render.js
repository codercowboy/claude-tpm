#!/usr/bin/env node
/**
 * lib/render.js — the tpm-task VIEW layer (build-plan Waves 5): age ladder, list/show
 ...
 *   is a local-midnight approximation (documented in task.md). The default `timezone:"local"`
 *   is exact end-to-end.
 */
